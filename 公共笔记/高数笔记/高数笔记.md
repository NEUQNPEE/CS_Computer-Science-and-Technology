...
8. $(x - \sin x) \sim \frac{1}{6}x^3 \sim (\arcsin x - x)$
9. $(\tan x - x) \sim \frac{1}{3}x^3\sim (x - \arctan x)$
10. $(\tan x - \sin x) \sim \frac{1}{2}x^3$

<img src="images/1709026782087.jpg" width="20%">
